...
FOLDER_PCB=PCB
FOLDER_CASE=case
FOLDER_GERBER=$FOLDER_PCB/gerber
FOLDER_PDF=pdf
...
C:/Program\ Files/KiCad/8.0/bin/kicad-cli.exe pcb export dxf -o $FOLDER_CASE/LaserCut.dxf -l User.Eco2 --ou mm $FOLDER_PCB/cornia.kicad_pcb
